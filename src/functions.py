...
def timestampset_timestamp_n(ss: Any, n: Any, result: Any) -> Any:
    return _lib.timestampset_timestamp_n(ss, n, result)
...
def period_shift_tscale(start: Any, duration: Any, result: Any) -> None:
    _lib.period_shift_tscale(start, duration, result)


def timestampset_shift_tscale(ss: Any, start: Any, duration: Any) -> Any:
    return _lib.timestampset_shift_tscale(ss, start, duration)
...
def stbox_make(hasx: Any, hasz: Any, hast: Any, geodetic: Any, srid: int, xmin: Any, xmax: Any, ymin: Any, ymax: Any, zmin: Any, zmax: Any, tmin: int, tmax: int) -> Any:
    srid_converted = _ffi.cast('int32', srid)
    tmin_converted = _ffi.cast('TimestampTz', tmin)
    tmax_converted = _ffi.cast('TimestampTz', tmax)
    return _lib.stbox_make(hasx, hasz, hast, geodetic, srid_converted, xmin, xmax, ymin, ymax, zmin, zmax, tmin_converted, tmax_converted)



def stbox_set(hasx: Any, hasz: Any, hast: Any, geodetic: Any, srid: int, xmin: Any, xmax: Any, ymin: Any, ymax: Any, zmin: Any, zmax: Any, tmin: int, tmax: int, box: Any) -> None:
    srid_converted = _ffi.cast('int32', srid)
    tmin_converted = _ffi.cast('TimestampTz', tmin)
    tmax_converted = _ffi.cast('TimestampTz', tmax)
    _lib.stbox_set(hasx, hasz, hast, geodetic, srid_converted, xmin, xmax, ymin, ymax, zmin, zmax, tmin_converted, tmax_converted, box)
...
def temporal_time_split(temp: Any, start: int, end: int, tunits: int, torigin: int, count: Any, buckets: Any, newcount: Any) -> Any:
    ...
    return _lib.temporal_time_split(temp, start_converted, end_converted, tunits_converted, torigin_converted, count, buckets, newcount)
