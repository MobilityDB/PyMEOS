...
class TimestampSet:
    ...
    def __init__(self, string: Optional[str] = None, *,
                 timestamp_list: Optional[List[Union[str, datetime]]] = None,
                 _inner=None):
        super().__init__()
        assert (_inner is not None) or ((string is not None) != 
            (timestamp_list is not None)), \
        ...
        if _inner is not None:
            ...
            times = [pg_timestamp_in(ts, -1) 
                if isinstance(ts, str) else datetime_to_timestamptz(ts)
    ...
    def from_hexwkb(hexwkb: str) -> TimestampSet:
        """
        Returns a `TimestampSet` from its WKB representation in hex-encoded
        ASCII.
    ...
    def timestamps(self) -> List[datetime]:
        ...
        return [timestamptz_to_datetime(tss[i]) \
    ...
    def is_adjacent(self, other: Union[Period, PeriodSet, Temporal, Box]) -> bool:
        ...
        if isinstance(other, Period):
            ...
            return adjacent_spanset_spanset(other._inner,
                set_to_spanset(self._inner))
        elif isinstance(other, Temporal):
            return adjacent_span_span(set_span(self._inner),
                temporal_to_period(other._inner))
        elif isinstance(other, get_args(Box)):
            return adjacent_span_span(set_span(self._inner),
                other.to_period()._inner)
        else:
    ...
    def is_contained_in(self, container: Union[Period, PeriodSet, TimestampSet,
        ...
        if isinstance(container, Period):
            ...
            return contained_spanset_spanset(set_to_spanset(self._inner),
                temporal_time(container._inner))
        elif isinstance(container, Box):
            return contained_span_span(set_span(self._inner),
                container.to_period()._inner)
        else:
    ...
    def contains(self, content: Union[datetime, TimestampSet, Temporal]) -> bool:
        ...
        if isinstance(content, datetime):
            ...
            return contains_spanset_spanset(set_to_spanset(self._inner),
                temporal_time(content._inner))
        else:
    ...
    def overlaps(self, other: Union[Period, PeriodSet, TimestampSet, Temporal,
        ...
        if isinstance(other, datetime):
            ...
            return overlaps_spanset_spanset(set_to_spanset(self._inner),
                other._inner)
        elif isinstance(other, Temporal):
            return overlaps_spanset_spanset(set_to_spanset(self._inner),
                temporal_time(other._inner))
        elif isinstance(other, Box):
            return overlaps_span_span(set_span(self._inner),
                other.to_period()._inner)
        else:
            raise TypeError(f'Operation not supported with type {other.__class__}')
    ...
    def is_after(self, other: Union[Time, Temporal, Box]) -> bool:
        ...
        if isinstance(other, datetime):
            ...
            return right_span_span(set_span(self._inner), 
                temporal_to_period(other._inner))
        elif isinstance(other, get_args(Box)):
            return right_span_span(set_span(self._inner), 
                other.to_period()._inner)
    ...
    def is_before(self, other: Union[Time, Temporal, Box]) -> bool:
        ...
        if isinstance(other, datetime):
            ...
            return left_span_span(set_span(self._inner),
                temporal_to_period(other._inner))
        elif isinstance(other, get_args(Box)):
            return left_span_span(set_span(self._inner),
                other.to_period()._inner)
    ...
    def is_over_or_after(self, other: Union[Time, Temporal, Box]) -> bool:
        ...
        from ..boxes import Box
        if isinstance(other, datetime):
            return overafter_period_timestamp(set_span(self._inner), 
                datetime_to_timestamptz(other))
        elif isinstance(other, TimestampSet):
            ...
            return overright_span_span(set_span(self._inner), 
                temporal_to_period(other._inner))
        elif isinstance(other, get_args(Box)):
            return overright_span_span(set_span(self._inner), 
                other.to_period()._inner)
    ...
    def is_over_or_before(self, other: Union[Time, Temporal, Box]) -> bool:
        ...
        MEOS Functions:
            overbefore_period_timestamp, overleft_span_span,
        ...
        from ..boxes import Box
        if isinstance(other, datetime):
            return overbefore_period_timestamp(set_span(self._inner),
                datetime_to_timestamptz(other))
        ...
        if isinstance(other, PeriodSet):
            ...
            return overleft_span_span(set_span(self._inner),
                temporal_to_period(other._inner))
        elif isinstance(other, get_args(Box)):
            return overleft_span_span(set_span(self._inner),
                other.to_period()._inner)
    ...
    def distance(self, other: Union[Time, Temporal, Box]) -> timedelta:
        ...
        from ..boxes import Box
        if isinstance(other, datetime):
            return timedelta(seconds=distance_timestampset_timestamp(self._inner, 
                datetime_to_timestamptz(other)))
        elif isinstance(other, TimestampSet):
            return timedelta(seconds=distance_set_set(self._inner, other._inner))
        elif isinstance(other, Period):
            return timedelta(seconds=distance_span_span(set_span(self._inner),
                other._inner))
        elif isinstance(other, PeriodSet):
            return timedelta(seconds=distance_spanset_span(other._inner,
                set_span(self._inner)))
        elif isinstance(other, Temporal):
            return timedelta(seconds=distance_span_span(set_span(self._inner),
                temporal_to_period(other._inner)))
    ...
    @overload
    def intersection(self, other: Union[Period, PeriodSet, Temporal]) -> \
        Optional[PeriodSet]:
        ...
    ...
    def intersection(self, other: Union[Time, Temporal]) -> Optional[Time]:
        ...
        from .periodset import PeriodSet
        if isinstance(other, datetime):
            result = intersection_set_set(self._inner,
                timestamp_to_tstzset(datetime_to_timestamptz(other)))
            ...
            result = intersection_spanset_span(set_to_spanset(self._inner),
                other._inner)
            return PeriodSet(_inner=result) if result is not None else None
        elif isinstance(other, PeriodSet):
            result = intersection_spanset_spanset(set_to_spanset(self._inner),
                other._inner)
            return PeriodSet(_inner=result) if result is not None else None
        else:
            raise TypeError(f'Operation not supported with type {other.__class__}')
    ...
    @overload
    def minus(self, other: Union[datetime, TimestampSet]) -> \
        Optional[TimestampSet]:
        ...
    ...
    def minus(self, other: Time) -> Optional[Time]:
        ...
        if isinstance(other, datetime):
            ...
            result = minus_spanset_span(set_to_spanset(self._inner), 
                other._inner)
            return PeriodSet(_inner=result) if result is not None else None
        elif isinstance(other, PeriodSet):
            result = minus_spanset_spanset(set_to_spanset(self._inner), 
                other._inner)
            return PeriodSet(_inner=result) if result is not None else None
        else:
            raise TypeError(f'Operation not supported with type {other.__class__}')
    ...
    def union(self, other: Time) -> Union[PeriodSet, TimestampSet]:
        ...
        from .periodset import PeriodSet
        if isinstance(other, datetime):
            return TimestampSet(_inner=union_timestampset_timestamp(self._inner,
                datetime_to_timestamptz(other)))
        elif isinstance(other, TimestampSet):
            return TimestampSet(_inner=union_set_set(self._inner, other._inner))
        elif isinstance(other, Period):
            return PeriodSet(_inner=union_spanset_span(
                set_to_spanset(self._inner), other._inner))
        elif isinstance(other, PeriodSet):
            return PeriodSet(_inner=union_spanset_spanset(
                set_to_spanset(self._inner), other._inner))
        else:
            raise TypeError(f'Operation not supported with type {other.__class__}')
    ...
    def read_from_cursor(value, _=None):
        """
        Reads a :class:`TimestampSet` from a database cursor. Used when
