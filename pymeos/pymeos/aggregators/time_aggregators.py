...
class TemporalInstantaneousUnionAggregator(BaseAggregator[Union[datetime, TimestampSet], TimestampSet]):
    """
...
class TemporalContinuousUnionAggregator(BaseAggregator[Union[Period, PeriodSet], PeriodSet]):
    """
