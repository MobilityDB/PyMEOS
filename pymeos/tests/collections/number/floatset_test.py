...
class TestFloatSetConstructors(TestFloatSet):
    ...
    def test_hexwkb_constructor(self):
        floatset = FloatSet.from_hexwkb('0106000103000000000000000000F03F00000000000000400000000000000840')
        self.assert_intset_equality(floatset, [1, 2, 3])
...
class TestFloatSetOutputs(TestFloatSet):
    ...
    def test_as_hexwkb(self):
        assert self.floatset.as_hexwkb() == '0106000103000000000000000000F03F00000000000000400000000000000840'
