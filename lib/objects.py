...
conversion_map: Dict[str, Conversion] = {
    ...
    'const text': Conversion('const text', 'str', lambda p_obj: f"cstring2text({p_obj})", lambda c_obj: f"text2cstring({c_obj})"),
    ...
    'TimestampTz *': Conversion('TimestampTz *', 'int', lambda p_obj: f"_ffi.cast('TimestampTz *', {p_obj})", None),
    'const TimestampTz': Conversion('const TimestampTz', 'int', lambda p_obj: f"_ffi.cast('const TimestampTz', {p_obj})", None),
    'const TimestampTz *': Conversion('const TimestampTz *', 'int', lambda p_obj: f"_ffi.cast('const TimestampTz *', {p_obj})", None),
