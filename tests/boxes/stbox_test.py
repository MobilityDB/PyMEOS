...
class TestSTBoxConstructors(TestSTBox):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ({"xmin": 0, "xmax": 2, "ymin": "1", "ymax": "3", "zmin": 10, "zmax": 12},
             "STBOX Z((0,1,10),(2,3,12))"),
            ({"xmin": 0, "xmax": 2, "ymin": "1", "ymax": "3", "tmin": "2000-01-01",
              "tmax": "2000-01-03"},
             "STBOX XT(((0,1),(2,3)),[2000-01-01 00:00:00+00, 2000-01-03 00:00:00+00])"),
            ({"xmin": 0, "xmax": 2, "ymin": "1", "ymax": "3", "zmin": 10, "zmax": 12,
              "tmin": datetime(2000, 1, 1), "tmax": datetime(2000, 1, 3)},
...
class TestSTBoxTransformations(TestSTBox):
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                    STBox(
                        "STBOX X((1.123456789,1.123456789),(2.123456789,2.123456789))"),
            ...
            (
                    ...
                    STBox(
                        "STBOX XT(((1.12,1.12),(2.12,2.12)),[2019-09-01, 2019-09-03])"),
            ),
            (
                    STBox(
